            ...
            <v-card class="card">
              ...
              <v-container>
                  ...
                  <v-card-text class="mt-5">
                    <p>Scrum Master</p>
                    <p class="mt-2">Facilita el proceso de Scrum y elimina obstáculos para el equipo.</p>
                  </v-card-text>
              </v-container>
            </v-card>
          </v-sheet>
          ...
          <v-sheet class="pa-2 ma-2">
            <v-card class="card">
              ...
              <v-container>
                  ...
                  <v-card-text class="mt-5">
                    <p>Product Owner</p>
                    <p class="mt-2">Define los requisitos del producto y prioriza el trabajo del equipo.</p>
                  </v-card-text>
              </v-container>
            </v-card>
          </v-sheet>
          ...
          <v-sheet class="pa-2 ma-2">
            <v-card class="card">
              <v-avatar size=80 class="align-center">
                <img
                  class="imgIconoCard"
                  src="@/assets/images/imgWorkingGroup/Jose.jpeg"
                  alt="icono-grupo"
                />
              </v-avatar>
              <v-container>
