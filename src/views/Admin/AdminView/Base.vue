    ...
    <v-card>
        <v-layout>
            <v-navigation-drawer expand-on-hover rail>
                <v-list>
                    <v-list-item prepend-avatar="" title="LOGO" subtitle="Medical Finder"></v-list-item>
                </v-list>

                <v-divider></v-divider>

                <v-list density="compact" nav>
                    <v-list-item prepend-icon="mdi-folder" title="Perfil" value="perfil"></v-list-item>
                    <v-list-item prepend-icon="mdi-account-multiple" title="Soporte" value="Soporte"></v-list-item>
                </v-list>
            </v-navigation-drawer>
...
export default {
    setup() {
        ...
        const name = useField('Nombre Completo')
        const phone = useField('Telefono')
